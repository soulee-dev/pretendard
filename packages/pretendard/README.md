...
-   [Pretendard JP](/packages/pretendard-jp/): 일본 환경에 적합하며, 추가 기능으로 한국 한자 환경에 맞춰 쓸 수 있습니다.
    -   Pretendard에 포함되지 않은 한국 한자와 일본 한자를 포함하고, 전각 유니코드가 없는 일부 기호를 전각으로 제공합니다.
    -   한국 한자 모양이 필요할 때는 스타일 세트 `ss05`로 전환할 수 있습니다.
-   [Pretendard Std](/packages/pretendard-std/): 라틴 환경에 적합합니다.
    -   Pretendard에서 한글을 제외한 버전으로, 라틴 또는 키릴 문자만 쓰는 환경에서 적은 용량으로 쓸 수 있습니다.
-   [Pretendard GOV](/packages/pretendard-gov/): 대한민국 공공 서비스 환경에 적합합니다.
    -   공백·숫자·기호 등이 한글 폭과 규칙성을 이루며, 한국 한자 모양을 기본으로 지원합니다.
    -   판독성을 높이고 오판독과 변조에 견고한 숫자·라틴 모양을 가집니다.
    -   공공 문서에서 자주 쓰이는 원문자·괄호문자 등 심벌을 새롭게 담았습니다.
    -   모바일 신분증과 KRDS 등에서 또렷한 판독성으로 채택되어 쓰이고 있습니다.

각 폰트의 설계 의도와 특징을 더 자세히 알고 싶다면 [#205](https://github.com/orioncactus/pretendard/issues/205)를 참고하세요.
